            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.column_metadata = new ArrayList<ColumnDef>(_list84.size);
                for (int _i85 = 0; _i85 < _list84.size; ++_i85)
                {
                  ColumnDef _elem86;
                  _elem86 = new ColumnDef();
                  _elem86.read(iprot);
                  struct.column_metadata.add(_elem86);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.compaction_strategy_options = new HashMap<String,String>(2*_map87.size);
                for (int _i88 = 0; _i88 < _map87.size; ++_i88)
                {
                  ...
                  struct.compaction_strategy_options.put(_key89, _val90);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.compression_options = new HashMap<String,String>(2*_map91.size);
                for (int _i92 = 0; _i92 < _map91.size; ++_i92)
                {
                  ...
                  struct.compression_options.put(_key93, _val94);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.column_metadata != null) {
        if (struct.isSetColumn_metadata()) {
          oprot.writeFieldBegin(COLUMN_METADATA_FIELD_DESC);
          {
            ...
            for (ColumnDef _iter95 : struct.column_metadata)
            {
              _iter95.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.compaction_strategy_options != null) {
        if (struct.isSetCompaction_strategy_options()) {
          oprot.writeFieldBegin(COMPACTION_STRATEGY_OPTIONS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter96 : struct.compaction_strategy_options.entrySet())
            {
      ...
      if (struct.compression_options != null) {
        if (struct.isSetCompression_options()) {
          oprot.writeFieldBegin(COMPRESSION_OPTIONS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter97 : struct.compression_options.entrySet())
            {
      ...
      if (struct.isSetColumn_metadata()) {
        {
          ...
          for (ColumnDef _iter98 : struct.column_metadata)
          {
            _iter98.write(oprot);
          }
        }
      ...
      if (struct.isSetCompaction_strategy_options()) {
        {
          ...
          for (Map.Entry<String, String> _iter99 : struct.compaction_strategy_options.entrySet())
          {
      ...
      if (struct.isSetCompression_options()) {
        {
          ...
          for (Map.Entry<String, String> _iter100 : struct.compression_options.entrySet())
          {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.column_metadata = new ArrayList<ColumnDef>(_list101.size);
          for (int _i102 = 0; _i102 < _list101.size; ++_i102)
          {
            ColumnDef _elem103;
            _elem103 = new ColumnDef();
            _elem103.read(iprot);
            struct.column_metadata.add(_elem103);
          }
        }
        struct.setColumn_metadataIsSet(true);
      }
      ...
      if (incoming.get(16)) {
        {
          ...
          struct.compaction_strategy_options = new HashMap<String,String>(2*_map104.size);
          for (int _i105 = 0; _i105 < _map104.size; ++_i105)
          {
            ...
            struct.compaction_strategy_options.put(_key106, _val107);
          }
        }
        struct.setCompaction_strategy_optionsIsSet(true);
      }
      if (incoming.get(17)) {
        {
          ...
          struct.compression_options = new HashMap<String,String>(2*_map108.size);
          for (int _i109 = 0; _i109 < _map108.size; ++_i109)
          {
            ...
            struct.compression_options.put(_key110, _val111);
          }
        }
        struct.setCompression_optionsIsSet(true);
      }
