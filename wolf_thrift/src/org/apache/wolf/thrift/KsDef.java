            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.strategy_options = new HashMap<String,String>(2*_map112.size);
                for (int _i113 = 0; _i113 < _map112.size; ++_i113)
                {
                  ...
                  struct.strategy_options.put(_key114, _val115);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.cf_defs = new ArrayList<CfDef>(_list116.size);
                for (int _i117 = 0; _i117 < _list116.size; ++_i117)
                {
                  CfDef _elem118;
                  _elem118 = new CfDef();
                  _elem118.read(iprot);
                  struct.cf_defs.add(_elem118);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.strategy_options != null) {
        if (struct.isSetStrategy_options()) {
          oprot.writeFieldBegin(STRATEGY_OPTIONS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter119 : struct.strategy_options.entrySet())
            {
  ...
  private static class KsDefTupleScheme extends TupleScheme<KsDef> {
      ...
      if (struct.isSetStrategy_options()) {
        {
          ...
          for (Map.Entry<String, String> _iter122 : struct.strategy_options.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, KsDef struct) throws org.apache.thrift.TException {
      ...
      struct.setStrategy_classIsSet(true);
      {
        ...
        struct.cf_defs = new ArrayList<CfDef>(_list123.size);
        for (int _i124 = 0; _i124 < _list123.size; ++_i124)
        {
          CfDef _elem125;
          _elem125 = new CfDef();
          _elem125.read(iprot);
          struct.cf_defs.add(_elem125);
        }
      }
      struct.setCf_defsIsSet(true);
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.strategy_options = new HashMap<String,String>(2*_map126.size);
          for (int _i127 = 0; _i127 < _map126.size; ++_i127)
          {
            ...
            struct.strategy_options.put(_key128, _val129);
          }
        }
        struct.setStrategy_optionsIsSet(true);
      }
