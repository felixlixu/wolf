...
#
# Interface definition for Wolf Service
#

namespace java org.apache.wolf.thrift
namespace cpp org.apache.wolf
namespace csharp Apache.Wolf
namespace py wolf
namespace php wolf
namespace perl Wolf
...
/**
    Methods for fetching rows/records from Wolf will return either a single instance of ColumnOrSuperColumn or a list
...
/**
    ...
    See also <a href="wolf.html#Struct_ColumnPath">ColumnPath</a>
 */
struct ColumnParent {
...
/** The ColumnPath is the path to a single column in Wolf. It might make sense to think of ColumnPath and
...
/**
    ...
    multiple columns. It could be thought of as Wolf's version of LIMIT and ORDER BY
...
/**
    ...
    SlicePredicate's in Wolf are described with either a list of column_names or a SliceRange.  If column_names is
...
/**
    A TokenRange describes part of the Wolf ring, it is a mapping from a range to
...
service Wolf {
  ...
  **/
  ...
  /**
   ...
   Internally, however, disk space will not be immediatily released, as with all deletes in wolf, this one
  ...
  */
  ...
  /**
   * Executes a CQL (Wolf Query Language) statement and returns a
  ...
  /**
   * Prepare a CQL (Wolf Query Language) statement by compiling and returning
  ...
  /**
   * Executes a prepared CQL (Wolf Query Language) statement by passing an id token and  a list of variables
